...
class LocationModelTests(unittest.TestCase):
    ...
    def test_header_regex(self):
        ...
        self.assertTupleEqual(top_left, (3.44, 12.22))
        self.assertTupleEqual(bottom_right, (600.66, 800.88))
    ...
    def test_line_regex(self):
        ...
        self.assertTupleEqual(notch, (3.44, 12.22))
        self.assertTupleEqual(tube, (600.66, 800.88))