...
class BaseModel(object):
    def __init__(self, dependencies=None, required_data_source=None):
        """
        :param required_data_source:   one of: "nd2", "imagereader"
        :type required_data_source:    str
        :param dependencies:    models that must be completed before this one can be started
        :type dependencies:     str
        """
        assert required_data_source in ("nd2", "image_reader", None)
        self._required_data_source = required_data_source
    ...
    def required_data_sources(self):
        return self._required_data_source
